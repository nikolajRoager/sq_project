...
\only<4>{\includegraphics[width=\linewidth]{dipole7.pdf}}%
\only<5>{TBD, image from torus simulation}%
...
\item<3-> Want exact to $p$'th order.

\item<4-> Local/global error  $~h^{p+1}$, Global error $~h^p$.
